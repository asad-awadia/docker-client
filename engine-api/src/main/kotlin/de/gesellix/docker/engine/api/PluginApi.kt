...
class PluginApi(basePath: String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun getPluginPrivilegesRequestConfig(remote: String): RequestConfig {
    ...
    return RequestConfig(
      ...
      elementType = PluginPrivilegeItem::class.java
    )
  }
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun pluginPull(remote: String, name: String?, xRegistryAuth: String?, body: List<PluginPrivilegeItem>?) {
   ...
   * @return RequestConfig
   */
  fun pluginPullRequestConfig(remote: String, name: String?, xRegistryAuth: String?, body: List<PluginPrivilegeItem>?): RequestConfig {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun pluginUpgrade(name: String, remote: String, xRegistryAuth: String?, body: List<PluginPrivilegeItem>?) {
   ...
   * @return RequestConfig
   */
  fun pluginUpgradeRequestConfig(name: String, remote: String, xRegistryAuth: String?, body: List<PluginPrivilegeItem>?): RequestConfig {
    val localVariableBody: Any? = body
    val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
      .apply {
        put("remote", listOf(remote))
